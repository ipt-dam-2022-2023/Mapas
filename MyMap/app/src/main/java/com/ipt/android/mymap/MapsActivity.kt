...
import com.ipt.android.mymap.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, LocationListener {
    ...
    override fun onLocationChanged(location: Location) {
        ...
        mMap.addMarker(MarkerOptions().position(aqui).title("Aqui"))
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(aqui,50.0f))
    }
